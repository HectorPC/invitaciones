<template>
        <div id="inputText" class="group" :type="type">
            <input type="date" :id="idDate" :name="name" @blur="validation" @focus="persistError" v-model="inputValue" :class="{'error-mark': isFormError}">
            <span class="bar">
...
input[type="date"]::-webkit-calendar-picker-indicator {
  ...
  opacity: 1;
  display: block;
  background-image: url("../../public/assets/img/calendar.jpg");
